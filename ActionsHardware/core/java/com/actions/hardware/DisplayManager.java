...
/**
 * This class lets you access the Display Engine hdmi.
 * <p>You can set which displayer output with {@link #setOutputDisplayer}.Also,you<br>
 * can set hdmi mode using {@link #setDisplayPara} and {@link #setHdmiVid} <br>
 * respectively etc..
 */
public class DisplayManager {
    ...
    /**
     * display mode bitmask: multi display port(hdmi) output image at the
     * same time
     */
    ...
    /**
     * get displayers including hdmi's info,such as resolution,aspect,Hz etc..
     * 
    ...
    /**
     * set two displayers to display,which include lcd and one of the tv displayers(hdmi).
    ...
    /**
     * set displayers' parameters,which include hdmi's res,hz,aspect mode.
    ...
    /**
     * get displayers' parameters,which include hdmi's res,hz,aspect mode.
