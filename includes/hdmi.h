...
struct hdmi_device_t {
    ...
    int (*get_vid)(struct hdmi_device_t *dev);
    int (*switch_set_status)(struct hdmi_device_t *dev, int state); 
    bool (*get_disconnect_flag)(struct hdmi_device_t *dev);
    int (*set_disconnect_flag)(struct hdmi_device_t *dev, bool flag);
    int (*set_manual_flag)(struct hdmi_device_t *dev, bool flag);
